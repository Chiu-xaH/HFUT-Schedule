package com.hfut.schedule.network.api.model
...
object Constant {
    ...
    // 教务系统-WEBVPN 校外访问
    val JXGLSTU_WEBVPN_URL by lazy { WebVpnConvertor.getWebVpnUrl(JXGLSTU_URL) }
    // 通知公告 有些通知需校园网
    ...
    // SB接口慢的一比
    const val UNI_APP_MAX_WAIT_TIME_SEC = 40L
    ...
    // 学生一张表 fixme:暂时决定不引入本数据源，成绩专业排名不全且排名明显不准
