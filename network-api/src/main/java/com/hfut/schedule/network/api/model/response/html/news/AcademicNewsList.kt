package com.hfut.schedule.network.api.model.response.html.news

data class AcademicNewsList(
    val news : List<News>,
    val totalPage : Int
)


enum class AcademicNewsType(
    val type : String,
    val title : String
) {
...
enum class AcademicNewsXuanChengType(
    val type : Int,
    val title : String
) {
    TEACHING(1177,"教学安排"),
