...
interface LibraryService {
    ...
    fun getBorrowed(
        ...
        @Query("limit") pageSize : Int = Constant.DEFAULT_PAGE_SIZE,
    ) : Call<ResponseBody>

    data class BookShelfRequest(val page: Int,val size : Int = Constant.DEFAULT_PAGE_SIZE)
    ...
    data class BookCollectRequest(val page: Int, val limit : Int = Constant.DEFAULT_PAGE_SIZE, val sorts : List<String> = emptyList())
    ...
    data class BookSearchRequest(val page : Int, val conditions : List<BookSearchRequestKeywordBean>, val source : BookSearchRequestSourceBean?, val size : Int = Constant.DEFAULT_PAGE_SIZE, val sort : Int = 1)
