...
object SettingsLiveUpdateDestination : NavDestination() {
    override val key: String = "settings_live_update"
    override val title: UiText = res(R.string.navigation_label_live_update)
    override val icon = R.drawable.notifications_active
