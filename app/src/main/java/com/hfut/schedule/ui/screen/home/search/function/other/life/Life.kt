...
fun Life(
    ...
    TransplantListItem(
        ...
        leadingContent = {
            Icon(painterResource(AppNavRoute.Life.icon), contentDescription = null,modifier = Modifier.iconElementShare(sharedTransitionScope,animatedContentScope = animatedContentScope, route = route))
        },
        ...
        CustomTransitionScaffold (
            ...
            topBar = {
                MediumTopAppBar(
                    ...
                    navigationIcon = {
                        TopBarNavigationIcon(navController,animatedContentScope,route, AppNavRoute.Life.icon)
                    },
                )
            },
        ) { innerPadding ->
