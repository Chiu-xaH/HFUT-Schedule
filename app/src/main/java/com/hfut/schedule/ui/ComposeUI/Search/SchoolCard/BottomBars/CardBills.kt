...
import com.hfut.schedule.ui.ComposeUI.Search.SchoolCard.BillsIcons
...
@Composable
fun CardBills(vm : LoginSuccessViewModel,innerPaddings : PaddingValues) {
