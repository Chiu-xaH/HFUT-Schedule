...
import com.hfut.schedule.ui.ComposeUI.Search.SchoolCard.drawLineChart
...
fun CardCounts(vm : LoginSuccessViewModel,innerPaddings : PaddingValues) {
    ...
    Column(modifier = Modifier
        ...
        DropdownMenu(expanded = showitem, onDismissRequest = { showitem = false }, offset = DpOffset(150.dp,150.dp)) {
        ...
        DropdownMenu(expanded = showitem_year, onDismissRequest = { showitem_year = false }, offset = DpOffset(70.dp,110.dp)) {
        ...
        Row(modifier = Modifier
            .fillMaxWidth()
            .padding(horizontal = 15.dp, vertical = 0.dp), horizontalArrangement = Arrangement.Center){
