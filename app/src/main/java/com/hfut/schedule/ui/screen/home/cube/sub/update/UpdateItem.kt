...
//        UpdateItems("新增 对共建平台已上传卡片的信息编辑", null, UpdateType.ADD)
        UpdateItems("重构 网络请求层，重新进行封装，使用Flow代替LiveData，优化潜在的内存泄漏问题，增加不同状态下的展示", "进度: 完成59/总99",UpdateType.RENEW)
        UpdateItems("优化 应用内打开邮箱链接无法跳转的问题，新增浏览器打开按钮", null, UpdateType.OPTIMIZE)
        UpdateItems("新增 层级实时模糊向下适配至所有安卓版本，但Android11及其以下设备不支持顶栏底栏模糊", null, UpdateType.OPTIMIZE)
