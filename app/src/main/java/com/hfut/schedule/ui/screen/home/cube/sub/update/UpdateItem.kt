...
private fun VersionInfoCard() {
    LargeCard(
        ...
        Row {
            TransplantListItem(
                overlineContent = { Text(text = "2025-05-10") },
...
//        UpdateItems("新增 对共建平台已上传卡片的信息编辑", null, UpdateType.ADD)
        UpdateItems("重构 网络请求层，重新进行封装，使用Flow代替LiveData，优化潜在的内存泄漏问题，增加不同状态下的展示", "进度: 完成47/搁置12/总102",UpdateType.RENEW)
        UpdateItems("修复 选课功能由于验证接口遗漏重构而造成除23级宣区用户无法使用的Bug", null, UpdateType.FIX)
