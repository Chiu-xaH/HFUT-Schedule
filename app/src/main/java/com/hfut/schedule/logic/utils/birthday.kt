...
import com.hfut.schedule.logic.utils.DateTimeUtils.formatter_YYYY_MM_DD
import com.hfut.schedule.logic.utils.parse.ParseJsons.getAPICelebration
...
// 阳历生日
fun isUserBirthday() : Boolean = getBirthday()?.let { DateTimeUtils.isTodayAnniversary(it.substringAfter("-")) } ?: false
// 毕业季
...
//    if(DateTimeUtils.isOnWeekend()) {
//        return Celebration(false,"周末")
//    }
